                                ...
                                <div className="flex items-center justify-center w-full">
                                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <img src={`http://hr-admin-api.test/storage/employees/avatars/` + employeeInput.avatar} alt={employeeInput.first_name} className="h-50 w-50" />
                            ...
                            <div className='md:ml-4 col-span-4'>
                                <div className='grid gap-2 grid-cols-1 md:grid-cols-2'>
                                    ...
                                    </div>
                                    {
                                        ...
                                        <>
                                            <Select
                                                options={managerDropdownList}
                                                isSearchable={true}
                                                name="manager_id"
                                                label="Manager"
                                                isRequired={true}
                                                defaultValue={employeeInput.manager_id}
